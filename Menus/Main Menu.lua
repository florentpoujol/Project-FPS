...
function Behavior:Awake()
    ...
    local data = { [1] = 1, [true] = "false", number = 123.456, ["string"] = 'foobar', boolean = false, ["table"] = { akey = 123 } }
     --[[   
    CS.Web.Post( "http://localhost/CSServerBrowser/index.php", data, CS.Web.ResponseType.JSON, function( error )
        if error ~= nil then
            print( "error post" )
            return
        end
