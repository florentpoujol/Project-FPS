...
-- The Z component of the returned Vector3 represent the distance from the camera to the plane
-- It is inferior to zero when the position is in front of the camera.
-- @param camera (Camera) The camera component.
-- @param position (Vector3) The position.
-- @return (Vector3) A Vector3 where X and Y are the screen position and Z the distanceThe screen position
